                            ...
                            @foreach($results as $result)
                                <tr>
                                    ...
                                    @if($result->university)
                                        <a href="{{$result->university->WEBSITE_URL}}" title="View University Website" target="_blank">{{ $result->university->VIEW_NAME }}</a>
                                    @else
                                        [College Name]
                                    @endif
                                    </td>
                                    <td><a href="{{$result->CRSEURL}}" title="View Course Details" target="_blank">{{$result->TITLE}}</a></td>
                                    <td>
                                    @if($result->university)
                                    ...
                                    <td>{{ $result->foundationLabel }}</td>
                                    <td>{{ $result->kismodeLabel }}</td>
                                    <td>{{ $result->sandwhichLabel }}</td>
                                    <td>{{ $result->yearAbroadLabel }}</td>
                                </tr>
                            @endforeach                     
                        </table>
